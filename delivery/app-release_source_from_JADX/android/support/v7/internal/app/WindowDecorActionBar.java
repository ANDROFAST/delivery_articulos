...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C05933();

    class C05933 implements ViewPropertyAnimatorUpdateListener {
        C05933() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0096R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0096R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0096R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0096R.id.action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0096R.id.split_action_bar);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0096R.styleable.ActionBar, C0096R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0096R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0096R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0096R.attr.actionBarWidgetTheme, outValue, true);
