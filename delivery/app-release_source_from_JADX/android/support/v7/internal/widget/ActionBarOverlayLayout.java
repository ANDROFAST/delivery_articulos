...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
    static final int[] ATTRS = new int[]{C0096R.attr.actionBarSize, 16842841};
    ...
    private final Runnable mAddActionBarHideOffset = new C01024();
    private boolean mAnimatingForFling;
    private final Rect mBaseContentInsets = new Rect();
    private final Rect mBaseInnerInsets = new Rect();
    private final ViewPropertyAnimatorListener mBottomAnimatorListener = new C08652();
    ...
    private final Runnable mRemoveActionBarHideOffset = new C01013();
    private final ViewPropertyAnimatorListener mTopAnimatorListener = new C08641();
    ...
    class C01024 implements Runnable {
        C01024() {
        }
    ...
    class C08652 extends ViewPropertyAnimatorListenerAdapter {
        C08652() {
        }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0096R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0096R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0096R.id.action_bar));
            this.mActionBarBottom = (ActionBarContainer) findViewById(C0096R.id.split_action_bar);
        }
    }
