...
public class RecyclerView extends ViewGroup {
    ...
    private static final Interpolator sQuinticInterpolator = new C01263();
    ...
    static class C01263 implements Interpolator {
        C01263() {
        }
    ...
    class C06014 implements Callback {
        C06014() {
        }
    ...
    class C06025 implements Callback {
        C06025() {
        }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01241();
        ...
        this.mItemAnimatorRunner = new C01252();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C06014());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C06025());
    }
