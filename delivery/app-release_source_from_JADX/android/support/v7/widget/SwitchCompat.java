...
public class SwitchCompat extends CompoundButton {
    ...
    private static final int[] TEXT_APPEARANCE_ATTRS = new int[]{16842904, 16842901, C0096R.attr.textAllCaps};
    ...
    public SwitchCompat(Context context, AttributeSet attrs) {
        this(context, attrs, C0096R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0096R.styleable.SwitchCompat, defStyleAttr, 0);
        this.mThumbDrawable = a.getDrawable(C0096R.styleable.SwitchCompat_android_thumb);
        this.mTrackDrawable = a.getDrawable(C0096R.styleable.SwitchCompat_track);
        this.mTextOn = a.getText(C0096R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = a.getText(C0096R.styleable.SwitchCompat_android_textOff);
        this.mShowText = a.getBoolean(C0096R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = a.getDimensionPixelSize(C0096R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = a.getDimensionPixelSize(C0096R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = a.getDimensionPixelSize(C0096R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = a.getBoolean(C0096R.styleable.SwitchCompat_splitTrack, false);
        int appearance = a.getResourceId(C0096R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (appearance != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        if (appearance.getBoolean(2, false)) {
                ...
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        if (thumbScrollRange != 0) {
                            ...
                            dPos = thumbScrollOffset > 0.0f ? TextTrackStyle.DEFAULT_FONT_SCALE : -1.0f;
                        }
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        ...
        final float diff = (newCheckedState ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f) - startPosition;
