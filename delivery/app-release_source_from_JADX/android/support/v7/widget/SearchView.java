...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0096R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0096R.styleable.SearchView, defStyleAttr, 0);
        this.mTintManager = a.getTintManager();
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(a.getResourceId(C0096R.styleable.SearchView_layout, 0), this, true);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0096R.id.search_src_text);
        this.mQueryTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0096R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0096R.id.search_plate);
        this.mSubmitArea = findViewById(C0096R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0096R.id.search_button);
        this.mSubmitButton = (ImageView) findViewById(C0096R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0096R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0096R.id.search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0096R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0096R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0096R.styleable.SearchView_submitBackground));
        this.mSearchIconResId = a.getResourceId(C0096R.styleable.SearchView_searchIcon, 0);
        this.mSearchButton.setImageResource(this.mSearchIconResId);
        this.mSubmitButton.setImageDrawable(a.getDrawable(C0096R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0096R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0096R.styleable.SearchView_voiceIcon));
        this.mSearchHintIcon.setImageDrawable(a.getDrawable(C0096R.styleable.SearchView_searchIcon));
        this.mSuggestionRowLayout = a.getResourceId(C0096R.styleable.SearchView_suggestionRowLayout, 0);
        this.mSuggestionCommitIconResId = a.getResourceId(C0096R.styleable.SearchView_commitIcon, 0);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C01314());
        setIconifiedByDefault(a.getBoolean(C0096R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0096R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        CharSequence queryHint = a.getText(C0096R.styleable.SearchView_queryHint);
        if (!TextUtils.isEmpty(queryHint)) {
            setQueryHint(queryHint);
        }
        int imeOptions = a.getInt(C0096R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0096R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0096R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0096R.dimen.abc_search_view_preferred_width);
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0096R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0096R.dimen.abc_dropdownitem_text_padding_left) : 0;
