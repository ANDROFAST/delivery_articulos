...
class ActionBarActivityDelegateBase extends ActionBarActivityDelegate implements Callback {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C00921();
    ...
    private static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0096R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0096R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0096R.style.Theme_AppCompat_CompactMenu, true);
            }
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0096R.layout.abc_list_menu_item_layout);
    ...
    class C05902 implements OnApplyWindowInsetsListener {
        C05902() {
        }
    ...
    class C05913 implements OnFitSystemWindowsListener {
        C05913() {
        }
    ...
    final void ensureSubDecor() {
        if (!this.mSubDecorInstalled) {
            if (this.mHasActionBar) {
                ...
                TypedValue outValue = new TypedValue();
                this.mActivity.getTheme().resolveAttribute(C0096R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mActivity, outValue.resourceId);
                } else {
                    themedContext = this.mActivity;
                }
                this.mSubDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0096R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) this.mSubDecor.findViewById(C0096R.id.decor_content_parent);
                ...
                if (this.mOverlayActionMode) {
                    this.mSubDecor = (ViewGroup) LayoutInflater.from(this.mActivity).inflate(C0096R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    this.mSubDecor = (ViewGroup) LayoutInflater.from(this.mActivity).inflate(C0096R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(this.mSubDecor, new C05902());
                } else {
                    ((FitWindowsViewGroup) this.mSubDecor).setOnFitSystemWindowsListener(new C05913());
                }
            }
            ...
            this.mActivity.findViewById(C0096R.id.action_bar_activity_content).setId(16908290);
    ...
    private void applyFixedSizeWindow() {
        ...
        if (a.hasValue(C0096R.styleable.Theme_windowFixedWidthMajor)) {
            if (null == null) {
                mFixedWidthMajor = new TypedValue();
            }
            a.getValue(C0096R.styleable.Theme_windowFixedWidthMajor, mFixedWidthMajor);
        }
        if (a.hasValue(C0096R.styleable.Theme_windowFixedWidthMinor)) {
            if (null == null) {
                mFixedWidthMinor = new TypedValue();
            }
            a.getValue(C0096R.styleable.Theme_windowFixedWidthMinor, mFixedWidthMinor);
        }
        if (a.hasValue(C0096R.styleable.Theme_windowFixedHeightMajor)) {
            if (null == null) {
                mFixedHeightMajor = new TypedValue();
            }
            a.getValue(C0096R.styleable.Theme_windowFixedHeightMajor, mFixedHeightMajor);
        }
        if (a.hasValue(C0096R.styleable.Theme_windowFixedHeightMinor)) {
            if (null == null) {
                mFixedHeightMinor = new TypedValue();
            }
            a.getValue(C0096R.styleable.Theme_windowFixedHeightMinor, mFixedHeightMinor);
        }
    ...
    ActionMode startSupportActionModeFromWindow(ActionMode.Callback callback) {
        ...
        if (this.mActionModeView == null) {
            if (this.mIsFloating) {
                ...
                this.mActionModePopup = new PopupWindow(context, null, C0096R.attr.actionModePopupWindowStyle);
                this.mActionModePopup.setContentView(this.mActionModeView);
                this.mActionModePopup.setWidth(-1);
                TypedValue heightValue = new TypedValue();
                this.mActivity.getTheme().resolveAttribute(C0096R.attr.actionBarSize, heightValue, true);
                ...
                this.mShowActionModePopup = new C00934();
            } else {
                ViewStubCompat stub = (ViewStubCompat) this.mActivity.findViewById(C0096R.id.action_mode_bar_stub);
                if (stub != null) {
    ...
    int getHomeAsUpIndicatorAttrId() {
        return C0096R.attr.homeAsUpIndicator;
    }
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        ...
        if ((st.featureId == 0 || st.featureId == 8) && this.mDecorContentParent != null) {
            ...
            baseTheme.resolveAttribute(C0096R.attr.actionBarTheme, outValue, true);
            Theme widgetTheme = null;
            if (outValue.resourceId != 0) {
                widgetTheme = context.getResources().newTheme();
                widgetTheme.setTo(baseTheme);
                widgetTheme.applyStyle(outValue.resourceId, true);
                widgetTheme.resolveAttribute(C0096R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0096R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mActivity.getResources().getColor(C0096R.color.abc_input_method_navigation_guard));
    ...
    private void ensureToolbarListMenuPresenter() {
        if (this.mToolbarListMenuPresenter == null) {
            TypedValue outValue = new TypedValue();
            this.mActivity.getTheme().resolveAttribute(C0096R.attr.panelMenuListTheme, outValue, true);
            this.mToolbarListMenuPresenter = new ListMenuPresenter(new ContextThemeWrapper(this.mActivity, outValue.resourceId != 0 ? outValue.resourceId : C0096R.style.Theme_AppCompat_CompactMenu), C0096R.layout.abc_list_menu_item_layout);
        }
    }
