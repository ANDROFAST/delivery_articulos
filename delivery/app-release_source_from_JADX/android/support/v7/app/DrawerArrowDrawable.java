...
abstract class DrawerArrowDrawable extends Drawable {
    ...
    DrawerArrowDrawable(Context context) {
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(null, C0096R.styleable.DrawerArrowToggle, C0096R.attr.drawerArrowStyle, C0096R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        this.mPaint.setAntiAlias(true);
        this.mPaint.setColor(typedArray.getColor(C0096R.styleable.DrawerArrowToggle_color, 0));
        this.mSize = typedArray.getDimensionPixelSize(C0096R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarSize = typedArray.getDimension(C0096R.styleable.DrawerArrowToggle_barSize, 0.0f);
        this.mTopBottomArrowSize = typedArray.getDimension(C0096R.styleable.DrawerArrowToggle_topBottomBarArrowSize, 0.0f);
        this.mBarThickness = typedArray.getDimension(C0096R.styleable.DrawerArrowToggle_thickness, 0.0f);
        this.mBarGap = typedArray.getDimension(C0096R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f);
        this.mSpin = typedArray.getBoolean(C0096R.styleable.DrawerArrowToggle_spinBars, true);
        this.mMiddleArrowSize = typedArray.getDimension(C0096R.styleable.DrawerArrowToggle_middleBarArrowSize, 0.0f);
        typedArray.recycle();
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mSpin) {
            ...
            canvas.rotate(BitmapDescriptorFactory.HUE_CYAN, (float) bounds.centerX(), (float) bounds.centerY());
        }
