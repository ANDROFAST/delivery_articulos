...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00571();
    ...
    private static final Interpolator sInterpolator = new C00582();
    ...
    private final Runnable mEndScrollRunnable = new C00593();
    ...
    static class C00571 implements Comparator<ItemInfo> {
        C00571() {
        }
    ...
    static class C00582 implements Interpolator {
        C00582() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C05831());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C05831 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05831() {
            }
