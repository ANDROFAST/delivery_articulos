...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00334();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00323();
    ...
    final OnWindowAttachListener mWindowAttachListener = new C00301();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00312();

    class C00301 implements OnWindowAttachListener {
        C00301() {
        }
    ...
    class C00312 implements OnWindowFocusChangeListener {
        C00312() {
        }
    ...
    class C00323 extends BroadcastReceiver {
        C00323() {
        }
    ...
    class C00334 implements OnAudioFocusChangeListener {
        C00334() {
        }
