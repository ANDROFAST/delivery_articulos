...
public class TransportMediator extends TransportController {
    ...
    class C00292 implements Callback {
        C00292() {
        }
    ...
    class C05751 implements TransportMediatorCallback {
        C05751() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C05751();
        this.mKeyEventCallback = new C00292();
