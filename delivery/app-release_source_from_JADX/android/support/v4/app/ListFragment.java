...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00202();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00191();
    ...
    class C00202 implements OnItemClickListener {
        C00202() {
        }
