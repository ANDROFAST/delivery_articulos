...
public enum CardType {
    ...
    static {
        ...
        f1052b = hashMap;
        hashMap.put(m830a("300", "305"), DINERSCLUB);
        f1052b.put(m830a("309", null), DINERSCLUB);
        f1052b.put(m830a("34", null), AMEX);
        f1052b.put(m830a("3528", "3589"), JCB);
        f1052b.put(m830a("36", null), DINERSCLUB);
        f1052b.put(m830a("37", null), AMEX);
        f1052b.put(m830a("38", "39"), DINERSCLUB);
        f1052b.put(m830a("4", null), VISA);
        f1052b.put(m830a("50", null), MAESTRO);
        f1052b.put(m830a("51", "55"), MASTERCARD);
        f1052b.put(m830a("56", "59"), MAESTRO);
        f1052b.put(m830a("6011", null), DISCOVER);
        f1052b.put(m830a("61", null), MAESTRO);
        f1052b.put(m830a("62", null), DISCOVER);
        f1052b.put(m830a("63", null), MAESTRO);
        f1052b.put(m830a("644", "649"), DISCOVER);
        f1052b.put(m830a("65", null), DISCOVER);
        f1052b.put(m830a("66", "69"), MAESTRO);
        f1052b.put(m830a("88", null), DISCOVER);
        for (Entry entry : f1052b.entrySet()) {
            f1051a = Math.max(f1051a, ((String) ((Pair) entry.getKey()).first).length());
            if (((Pair) entry.getKey()).second != null) {
                f1051a = Math.max(f1051a, ((String) ((Pair) entry.getKey()).second).length());
            }
        }
    }
    ...
    private static Pair m830a(String str, String str2) {
        Object obj;
        if (str2 == null) {
            obj = str;
        }
    ...
    public final String getDisplayName(String str) {
        switch (C0559f.f1077a[ordinal()]) {
            case 1:
                return cZ.m420a(da.CARDTYPE_AMERICANEXPRESS, str);
            case 2:
            case 3:
                return cZ.m420a(da.CARDTYPE_DISCOVER, str);
            case 4:
                return cZ.m420a(da.CARDTYPE_JCB, str);
            case 5:
                return cZ.m420a(da.CARDTYPE_MASTERCARD, str);
            case 6:
                return cZ.m420a(da.CARDTYPE_VISA, str);
            default:
                return null;
        }
    }
    ...
    public final Bitmap imageBitmap(Context context) {
        ...
        return str != null ? dF.m446c(str, context) : null;
    }
