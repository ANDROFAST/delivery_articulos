...
public final class BarcodeDetector extends Detector<Barcode> {
    ...
    public static class Builder {
        ...
        private BarcodeDetectorOptions zzbip = new BarcodeDetectorOptions();
        ...
        public BarcodeDetector build() {
            return new BarcodeDetector(new zzd(this.mContext, this.zzbip));
        }

        public Builder setBarcodeFormats(int format) {
            this.zzbip.zzbiq = format;
            return this;
        }
    }
    ...
    public SparseArray<Barcode> detect(Frame frame) {
        ...
        if (frame.getBitmap() != null) {
            zza = this.zzbio.zza(frame.getBitmap(), zzc);
        } else {
            zza = this.zzbio.zza(frame.getGrayscaleImageData(), zzc);
        }
