...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class zza implements zzd {
            ...
            public zzc zza(com.google.android.gms.dynamic.zzd com_google_android_gms_dynamic_zzd, FaceSettingsParcel faceSettingsParcel) throws RemoteException {
                ...
                try {
                    ...
                    zzc zzeb = com.google.android.gms.vision.face.internal.client.zzc.zza.zzeb(obtain2.readStrongBinder());
                    return zzeb;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static zzd zzec(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    zzc zza = zza(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()), data.readInt() != 0 ? FaceSettingsParcel.CREATOR.zzgY(data) : null);
