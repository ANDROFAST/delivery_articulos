...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class zza implements zzc {
            ...
            public void zzGm() throws RemoteException {
            ...
            public boolean zzks(int i) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
        ...
        public static zzc zzeb(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    Parcelable[] zzc = zzc(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()), data.readInt() != 0 ? FrameMetadataParcel.CREATOR.zzha(data) : null);
                    reply.writeNoException();
                    reply.writeTypedArray(zzc, 1);
                    return true;
                case 2:
                    data.enforceInterface("com.google.android.gms.vision.face.internal.client.INativeFaceDetector");
                    boolean zzks = zzks(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(zzks ? 1 : 0);
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.vision.face.internal.client.INativeFaceDetector");
                    zzGm();
