...
public class AppContentActionEntityCreator implements Creator<AppContentActionEntity> {
    static void zza(AppContentActionEntity appContentActionEntity, Parcel parcel, int i) {
        ...
        zzb.zzc(parcel, 1, appContentActionEntity.zzvj(), false);
        zzb.zzc(parcel, 1000, appContentActionEntity.getVersionCode());
        zzb.zza(parcel, 2, appContentActionEntity.zzvk(), false);
        ...
        zzb.zza(parcel, 8, appContentActionEntity.zzvi(), i, false);
        zzb.zza(parcel, 9, appContentActionEntity.zzvl(), false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public AppContentActionEntity zzdX(Parcel parcel) {
        String str = null;
    ...
    public AppContentActionEntity[] zzfZ(int i) {
