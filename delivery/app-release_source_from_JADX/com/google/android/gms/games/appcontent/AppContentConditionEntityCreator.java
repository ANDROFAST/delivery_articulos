...
public class AppContentConditionEntityCreator implements Creator<AppContentConditionEntity> {
    static void zza(AppContentConditionEntity appContentConditionEntity, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, appContentConditionEntity.zzvz(), false);
        zzb.zzc(parcel, 1000, appContentConditionEntity.getVersionCode());
        zzb.zza(parcel, 2, appContentConditionEntity.zzvA(), false);
        zzb.zza(parcel, 3, appContentConditionEntity.zzvB(), false);
        zzb.zza(parcel, 4, appContentConditionEntity.zzvC(), false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public AppContentConditionEntity zzea(Parcel parcel) {
        Bundle bundle = null;
    ...
    public AppContentConditionEntity[] zzgc(int i) {
