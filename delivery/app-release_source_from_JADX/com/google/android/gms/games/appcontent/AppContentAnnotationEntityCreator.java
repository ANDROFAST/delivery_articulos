...
public class AppContentAnnotationEntityCreator implements Creator<AppContentAnnotationEntity> {
    static void zza(AppContentAnnotationEntity appContentAnnotationEntity, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, appContentAnnotationEntity.zzvp(), i, false);
        zzb.zza(parcel, 3, appContentAnnotationEntity.getTitle(), false);
        zzb.zza(parcel, 5, appContentAnnotationEntity.getId(), false);
        zzb.zza(parcel, 6, appContentAnnotationEntity.zzvs(), false);
        zzb.zza(parcel, 7, appContentAnnotationEntity.zzvn(), false);
        zzb.zzc(parcel, 8, appContentAnnotationEntity.zzvo());
        zzb.zzc(parcel, 9, appContentAnnotationEntity.zzvr());
        zzb.zza(parcel, 10, appContentAnnotationEntity.zzvq(), false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public AppContentAnnotationEntity zzdY(Parcel parcel) {
        int i = 0;
        Bundle bundle = null;
    ...
    public AppContentAnnotationEntity[] zzga(int i) {
