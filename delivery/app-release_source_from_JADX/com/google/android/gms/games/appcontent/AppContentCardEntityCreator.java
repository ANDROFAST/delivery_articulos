...
public class AppContentCardEntityCreator implements Creator<AppContentCardEntity> {
    static void zza(AppContentCardEntity appContentCardEntity, Parcel parcel, int i) {
        ...
        zzb.zzc(parcel, 2, appContentCardEntity.zzvu(), false);
        zzb.zzc(parcel, 3, appContentCardEntity.zzvj(), false);
        zzb.zza(parcel, 4, appContentCardEntity.zzvk(), false);
        zzb.zzc(parcel, 5, appContentCardEntity.zzvv());
        zzb.zza(parcel, 6, appContentCardEntity.getDescription(), false);
        zzb.zza(parcel, 7, appContentCardEntity.getExtras(), false);
        zzb.zza(parcel, 10, appContentCardEntity.zzvw(), false);
        zzb.zza(parcel, 11, appContentCardEntity.getTitle(), false);
        zzb.zzc(parcel, 12, appContentCardEntity.zzvx());
    ...
    public AppContentCardEntity zzdZ(Parcel parcel) {
    ...
    public AppContentCardEntity[] zzgb(int i) {
