...
public abstract class RoomConfig {
    ...
    public static final class Builder {
        ...
        private Builder(RoomUpdateListener updateListener) {
            ...
            this.zzaHk = (RoomUpdateListener) zzx.zzb((Object) updateListener, (Object) "Must provide a RoomUpdateListener");
        }
        ...
        public Builder addPlayersToInvite(String... playerIds) {
            zzx.zzy(playerIds);
            this.zzaHo.addAll(Arrays.asList(playerIds));
            return this;
        }
        ...
        public Builder setInvitationIdToAccept(String invitationId) {
            zzx.zzy(invitationId);
            this.zzaHn = invitationId;
            return this;
        }
