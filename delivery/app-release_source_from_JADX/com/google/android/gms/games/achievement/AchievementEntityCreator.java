...
public class AchievementEntityCreator implements Creator<AchievementEntity> {
    static void zza(AchievementEntity achievementEntity, Parcel parcel, int i) {
        ...
        zzb.zzc(parcel, 9, achievementEntity.zzve());
        zzb.zza(parcel, 10, achievementEntity.zzvf(), false);
        zzb.zza(parcel, 11, achievementEntity.getPlayer(), i, false);
        zzb.zzc(parcel, 12, achievementEntity.getState());
        zzb.zzc(parcel, 13, achievementEntity.zzvg());
        zzb.zza(parcel, 14, achievementEntity.zzvh(), false);
    ...
    public AchievementEntity zzdW(Parcel parcel) {
    ...
    public AchievementEntity[] zzfY(int i) {
