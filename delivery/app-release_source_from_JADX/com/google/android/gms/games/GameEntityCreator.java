...
public class GameEntityCreator implements Creator<GameEntity> {
    static void zza(GameEntity gameEntity, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 10, gameEntity.zzuR());
        zzb.zza(parcel, 11, gameEntity.zzuT());
        zzb.zza(parcel, 12, gameEntity.zzuU(), false);
        zzb.zzc(parcel, 13, gameEntity.zzuV());
        ...
        zzb.zza(parcel, 22, gameEntity.zzuS());
