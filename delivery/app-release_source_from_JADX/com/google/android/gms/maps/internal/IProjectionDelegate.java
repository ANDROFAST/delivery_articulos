    ...
    public static abstract class zza extends Binder implements IProjectionDelegate {
        ...
        private static class zza implements IProjectionDelegate {
            ...
            public LatLng fromScreenLocation(zzd point) throws RemoteException {
                ...
                try {
                    ...
                    if (obtain2.readInt() != 0) {
                        latLng = LatLng.CREATOR.zzfq(obtain2);
                    }
                    obtain2.recycle();
                    obtain.recycle();
                    return latLng;
            ...
            public VisibleRegion getVisibleRegion() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    VisibleRegion zzfB = obtain2.readInt() != 0 ? VisibleRegion.CREATOR.zzfB(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return zzfB;
                } catch (Throwable th) {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    zzd toScreenLocation = toScreenLocation(data.readInt() != 0 ? LatLng.CREATOR.zzfq(data) : null);
                    reply.writeNoException();
