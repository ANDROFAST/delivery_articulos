    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaDelegate {
        ...
        private static class zza implements IStreetViewPanoramaDelegate {
            ...
            public StreetViewPanoramaCamera getPanoramaCamera() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    StreetViewPanoramaCamera zzfv = obtain2.readInt() != 0 ? StreetViewPanoramaCamera.CREATOR.zzfv(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return zzfv;
                } catch (Throwable th) {
            ...
            public StreetViewPanoramaLocation getStreetViewPanoramaLocation() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    StreetViewPanoramaLocation zzfx = obtain2.readInt() != 0 ? StreetViewPanoramaLocation.CREATOR.zzfx(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return zzfx;
                } catch (Throwable th) {
            ...
            public StreetViewPanoramaOrientation pointToOrientation(zzd point) throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        streetViewPanoramaOrientation = StreetViewPanoramaOrientation.CREATOR.zzfy(obtain2);
                    }
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    animateTo(data.readInt() != 0 ? StreetViewPanoramaCamera.CREATOR.zzfv(data) : null, data.readLong());
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                ...
                case 15:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaChangeListener(com.google.android.gms.maps.internal.zzs.zza.zzcO(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaCameraChangeListener(com.google.android.gms.maps.internal.zzr.zza.zzcN(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 17:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaClickListener(com.google.android.gms.maps.internal.zzt.zza.zzcP(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                ...
                case 19:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    zzd orientationToPoint = orientationToPoint(data.readInt() != 0 ? StreetViewPanoramaOrientation.CREATOR.zzfy(data) : null);
                    reply.writeNoException();
                ...
                case 20:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaLongClickListener(com.google.android.gms.maps.internal.zzu.zza.zzcQ(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
