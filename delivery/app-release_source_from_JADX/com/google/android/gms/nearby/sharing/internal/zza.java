...
public interface zza extends IInterface {
    ...
    public static abstract class zza extends Binder implements zza {
        ...
        private static class zza implements zza {
            ...
            public String zzeO(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
        ...
        public static zza zzdA(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    String zzeO = zzeO(data.readString());
                    reply.writeNoException();
                    reply.writeString(zzeO);
                    return true;
                case 2:
                    data.enforceInterface("com.google.android.gms.nearby.sharing.internal.IAppContentReceiver");
    ...
    String zzeO(String str) throws RemoteException;
}
