...
public class zzc implements Creator<SharedContent> {
    static void zza(SharedContent sharedContent, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 8, sharedContent.zzCQ(), i, false);
        zzb.zza(parcel, 9, sharedContent.zzCR(), i, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public SharedContent zzgh(Parcel parcel) {
    ...
    public SharedContent[] zzjj(int i) {
