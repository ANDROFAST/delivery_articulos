...
public class zzd implements Creator<DisconnectRequest> {
    static void zza(DisconnectRequest disconnectRequest, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, disconnectRequest.zzCm(), i, false);
        zzb.zzc(parcel, 1000, disconnectRequest.versionCode);
        zzb.zza(parcel, 2, disconnectRequest.zzui(), false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public DisconnectRequest zzfK(Parcel parcel) {
    ...
    public DisconnectRequest[] zziD(int i) {
