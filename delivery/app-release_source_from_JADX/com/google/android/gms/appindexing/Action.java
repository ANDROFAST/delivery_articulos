...
public final class Action extends Thing {
    ...
    public static final class Builder extends com.google.android.gms.appindexing.Thing.Builder {
        ...
        public Action build() {
            zzx.zzb(this.zzTn.get("object"), (Object) "setObject is required before calling build().");
            zzx.zzb(this.zzTn.get("type"), (Object) "setType is required before calling build().");
            Bundle bundle = (Bundle) this.zzTn.getParcelable("object");
