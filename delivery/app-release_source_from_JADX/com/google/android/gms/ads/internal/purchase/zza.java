...
public class zza implements Creator<GInAppPurchaseManagerInfoParcel> {
    static void zza(GInAppPurchaseManagerInfoParcel gInAppPurchaseManagerInfoParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 3, gInAppPurchaseManagerInfoParcel.zzfG(), false);
        zzb.zza(parcel, 4, gInAppPurchaseManagerInfoParcel.zzfH(), false);
        zzb.zza(parcel, 5, gInAppPurchaseManagerInfoParcel.zzfI(), false);
        zzb.zza(parcel, 6, gInAppPurchaseManagerInfoParcel.zzfF(), false);
        zzb.zzI(parcel, zzav);
    }
