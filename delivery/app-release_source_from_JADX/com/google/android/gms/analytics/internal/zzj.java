...
class zzj extends zzd implements Closeable {
    ...
    class zza extends SQLiteOpenHelper {
        ...
        private boolean zza(SQLiteDatabase sQLiteDatabase, String str) {
            ...
            try {
                ...
                try {
                    ...
                    e = e2;
                    try {
                        this.zzPC.zzc("Error querying for table", str, e);
                        if (query != null) {
                            query.close();
                        }
                        return false;
        ...
        public SQLiteDatabase getWritableDatabase() {
            if (this.zzPC.zzPB.zzv(3600000)) {
                SQLiteDatabase writableDatabase;
                try {
                    writableDatabase = super.getWritableDatabase();
                } catch (SQLiteException e) {
                    this.zzPC.zzPB.start();
                    this.zzPC.zzbe("Opening the database failed, dropping the table and recreating it");
                    this.zzPC.getContext().getDatabasePath(this.zzPC.zzjz()).delete();
                    try {
                        writableDatabase = super.getWritableDatabase();
                        this.zzPC.zzPB.clear();
                    } catch (SQLiteException e2) {
                        this.zzPC.zze("Failed to open freshly created database", e2);
                        throw e2;
                    }
                }
    ...
    zzj(zzf com_google_android_gms_analytics_internal_zzf) {
        ...
        this.zzPz = new zza(this, com_google_android_gms_analytics_internal_zzf.getContext(), zzjz());
    }
    ...
    private String zzd(zzab com_google_android_gms_analytics_internal_zzab) {
        return com_google_android_gms_analytics_internal_zzab.zzlc() ? zziV().zzko() : zziV().zzkp();
    }
    ...
    private String zzjz() {
        return !zziV().zzka() ? zziV().zzkA() : zziV().zzkb() ? zziV().zzkA() : zziV().zzkB();
    }
    ...
    public void zzb(zzh com_google_android_gms_analytics_internal_zzh) {
        ...
        String zzB = zzB(com_google_android_gms_analytics_internal_zzh.zzn());
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_uid", Long.valueOf(com_google_android_gms_analytics_internal_zzh.zzjm()));
        contentValues.put("cid", com_google_android_gms_analytics_internal_zzh.getClientId());
        contentValues.put("tid", com_google_android_gms_analytics_internal_zzh.zzjn());
        contentValues.put("adid", Integer.valueOf(com_google_android_gms_analytics_internal_zzh.zzjo() ? 1 : 0));
        contentValues.put("hits_count", Long.valueOf(com_google_android_gms_analytics_internal_zzh.zzjp()));
    ...
    public void zzc(zzab com_google_android_gms_analytics_internal_zzab) {
        ...
        if (zze.length() > 8192) {
            zziU().zza(com_google_android_gms_analytics_internal_zzab, "Hit length exceeds the maximum allowed size");
            return;
        }
        zzjy();
        SQLiteDatabase writableDatabase = getWritableDatabase();
        ...
        contentValues.put("hit_time", Long.valueOf(com_google_android_gms_analytics_internal_zzab.zzla()));
        contentValues.put("hit_app_id", Integer.valueOf(com_google_android_gms_analytics_internal_zzab.zzkY()));
    ...
    L_0x0059:
        ...
        r2 = r13.zzbf(r0);	 Catch:{ SQLiteException -> 0x00a4, all -> 0x00a2 }
        r5 = com.google.android.gms.analytics.internal.zzam.zzbu(r1);	 Catch:{ SQLiteException -> 0x00a4, all -> 0x00a2 }
    ...
    public java.util.List<com.google.android.gms.analytics.internal.zzh> zzr(long r14) {
        ...
        r3 = "params";
        r2[r1] = r3;	 Catch:{ SQLiteException -> 0x00ba, all -> 0x00b8 }
        r1 = r13.zziV();	 Catch:{ SQLiteException -> 0x00ba, all -> 0x00b8 }
        r10 = r1.zzkz();	 Catch:{ SQLiteException -> 0x00ba, all -> 0x00b8 }
    ...
    L_0x0065:
        ...
        r8 = r13.zzbg(r0);	 Catch:{ SQLiteException -> 0x00a8, all -> 0x00b8 }
    ...
    L_0x0091:
        ...
        r13.zzbd(r0);	 Catch:{ SQLiteException -> 0x00a8, all -> 0x00b8 }
    L_0x0096:
