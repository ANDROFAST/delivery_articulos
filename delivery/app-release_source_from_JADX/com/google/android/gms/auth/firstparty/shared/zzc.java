...
public class zzc implements Creator<ScopeDetail> {
    static void zza(ScopeDetail scopeDetail, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 3, scopeDetail.zzWR, false);
        zzb.zza(parcel, 4, scopeDetail.zzWS, false);
        zzb.zza(parcel, 5, scopeDetail.zzWT, false);
        zzb.zza(parcel, 6, scopeDetail.zzWU, false);
        zzb.zzb(parcel, 7, scopeDetail.zzWV, false);
        zzb.zza(parcel, 8, scopeDetail.zzWW, i, false);
        zzb.zzI(parcel, zzav);
    }
