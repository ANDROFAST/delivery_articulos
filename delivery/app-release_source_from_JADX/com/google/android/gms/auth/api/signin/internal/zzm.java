...
public class zzm implements Creator<SignInConfiguration> {
    static void zza(SignInConfiguration signInConfiguration, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 4, signInConfiguration.zzmQ(), i, false);
        zzb.zza(parcel, 5, signInConfiguration.zzmR(), i, false);
        zzb.zza(parcel, 6, signInConfiguration.zzmS(), i, false);
        ...
        while (parcel.dataPosition() < zzau) {
            ...
            switch (zza.zzcc(zzat)) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    facebookSignInOptions = (FacebookSignInOptions) zza.zza(parcel, zzat, FacebookSignInOptions.CREATOR);
                    break;
                case 7:
