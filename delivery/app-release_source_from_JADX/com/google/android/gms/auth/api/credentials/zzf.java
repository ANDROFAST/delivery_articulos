...
public class zzf implements Creator<PasswordSpecification> {
    static void zza(PasswordSpecification passwordSpecification, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, passwordSpecification.zzUQ, false);
        zzb.zzc(parcel, 1000, passwordSpecification.mVersionCode);
        zzb.zzb(parcel, 2, passwordSpecification.zzUR, false);
        zzb.zza(parcel, 3, passwordSpecification.zzUS, false);
        zzb.zzc(parcel, 4, passwordSpecification.zzUT);
        zzb.zzc(parcel, 5, passwordSpecification.zzUU);
        zzb.zzI(parcel, zzav);
    }
