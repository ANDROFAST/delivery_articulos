...
public class zzb implements Creator<ProxyRequest> {
    static void zza(ProxyRequest proxyRequest, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 5, proxyRequest.zzVe, false);
    ...
    public ProxyRequest zzN(Parcel parcel) {
        int i = 0;
        Bundle bundle = null;
    ...
    public ProxyRequest[] zzaI(int i) {
