...
public final class MediaStatus {
    ...
    private int zzZN = 0;
    private int zzZO = 0;
    private final zza zzZP = new zza(this);
    ...
    private class zza {
        ...
        final /* synthetic */ MediaStatus zzZT;

        zza(MediaStatus mediaStatus) {
            this.zzZT = mediaStatus;
        }
        ...
        private void zza(MediaQueueItem[] mediaQueueItemArr) {
            ...
            for (int i = 0; i < mediaQueueItemArr.length; i++) {
                ...
                this.zzZS.put(mediaQueueItem.getItemId(), Integer.valueOf(i));
            }
        }

        private Integer zzbd(int i) {
            return (Integer) this.zzZS.get(i);
        }
        ...
        public MediaQueueItem zzbb(int i) {
            Integer num = (Integer) this.zzZS.get(i);
            return num == null ? null : (MediaQueueItem) this.zzZR.get(num.intValue());
        }

        public MediaQueueItem zzbc(int i) {
            return (i < 0 || i >= this.zzZR.size()) ? null : (MediaQueueItem) this.zzZR.get(i);
        }
    ...
    public boolean isMediaCommandSupported(long mediaCommand) {
        return (this.zzZK & mediaCommand) != 0;
    }
    ...
    public int zza(JSONObject jSONObject, int i) throws JSONException {
        ...
        if (jSONObject.has("activeTrackIds")) {
            ...
            if (this.zzZC != null && this.zzZC.length == length) {
                for (i4 = 0; i4 < length; i4++) {
                    if (this.zzZC[i4] != jArr2[i4]) {
                        break;
                    }
                }
                i5 = 0;
        ...
        if (!zzi(this.zzZH, this.zzZN)) {
            return this.zzZP.zzg(jSONObject) ? i2 | 8 : i2;
        } else {
            this.zzZE = 0;
            this.zzZN = 0;
            this.zzZO = 0;
