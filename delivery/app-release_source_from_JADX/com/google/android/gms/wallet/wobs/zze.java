...
public class zze implements Creator<LoyaltyPoints> {
    static void zza(LoyaltyPoints loyaltyPoints, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 3, loyaltyPoints.zzblz, i, false);
        zzb.zza(parcel, 4, loyaltyPoints.type, false);
        zzb.zza(parcel, 5, loyaltyPoints.zzbjP, i, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public LoyaltyPoints zzhE(Parcel parcel) {
    ...
    public LoyaltyPoints[] zzlb(int i) {
