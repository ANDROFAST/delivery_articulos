...
public class zzd implements Creator<CreateWalletObjectsRequest> {
    static void zza(CreateWalletObjectsRequest createWalletObjectsRequest, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, createWalletObjectsRequest.zzbjd, i, false);
        zzb.zza(parcel, 3, createWalletObjectsRequest.zzbje, i, false);
        zzb.zza(parcel, 4, createWalletObjectsRequest.zzbjf, i, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public CreateWalletObjectsRequest zzhe(Parcel parcel) {
    ...
    public CreateWalletObjectsRequest[] zzky(int i) {
