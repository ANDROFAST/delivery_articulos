...
public class zze implements Creator<CoverPhotoEntity> {
    ...
    public CoverPhotoEntity zzgx(Parcel parcel) {
        int i = 0;
    ...
    public CoverPhotoEntity[] zzjA(int i) {
