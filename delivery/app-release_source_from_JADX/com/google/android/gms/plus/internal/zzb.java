...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        public static zzb zzdK(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    ...
                    if (data.readInt() != 0) {
                        personEntity = PersonEntity.CREATOR.zzgt(data);
                    }
                ...
                case 10:
                    data.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
                    zzba(data.readInt() != 0 ? (Status) Status.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 1598968902:
