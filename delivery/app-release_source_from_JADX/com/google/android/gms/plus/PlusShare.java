...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            zzx.zza(this.zzaYT, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                zzx.zza(PlusShare.zzeP(deepLinkId), (Object) "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            boolean z = true;
            boolean z2 = this.zzaYU != null && this.zzaYU.size() > 1;
            ...
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                zzx.zza(PlusShare.zzeP(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), (Object) "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            zzx.zzb(this.zzaYT, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
    ...
    protected static boolean zzeP(String str) {
