...
public class zzd implements Creator<DocumentSection> {
    static void zza(DocumentSection documentSection, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, documentSection.zzSu, false);
        zzb.zzc(parcel, 1000, documentSection.mVersionCode);
        zzb.zza(parcel, 3, documentSection.zzSv, i, false);
        zzb.zzc(parcel, 4, documentSection.zzSw);
        zzb.zza(parcel, 5, documentSection.zzSx, false);
        zzb.zzI(parcel, zzav);
    }
