...
public class zzi implements Creator<RegisterSectionInfo> {
    static void zza(RegisterSectionInfo registerSectionInfo, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, registerSectionInfo.zzSJ, false);
        zzb.zza(parcel, 3, registerSectionInfo.zzSK);
        zzb.zzc(parcel, 4, registerSectionInfo.weight);
        zzb.zza(parcel, 5, registerSectionInfo.zzSL);
        zzb.zza(parcel, 6, registerSectionInfo.zzSM, false);
        zzb.zza(parcel, 7, registerSectionInfo.zzSN, i, false);
        zzb.zza(parcel, 8, registerSectionInfo.zzSO, false);
        zzb.zza(parcel, 11, registerSectionInfo.zzSP, false);
        zzb.zzI(parcel, zzav);
    }
