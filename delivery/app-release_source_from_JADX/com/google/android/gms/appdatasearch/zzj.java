...
public class zzj implements Creator<UsageInfo> {
    static void zza(UsageInfo usageInfo, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, usageInfo.zzSY, i, false);
        zzb.zzc(parcel, 1000, usageInfo.mVersionCode);
        zzb.zza(parcel, 2, usageInfo.zzSZ);
        zzb.zzc(parcel, 3, usageInfo.zzTa);
        zzb.zza(parcel, 4, usageInfo.zzuU, false);
        zzb.zza(parcel, 5, usageInfo.zzTb, i, false);
        zzb.zza(parcel, 6, usageInfo.zzTc);
        zzb.zzc(parcel, 7, usageInfo.zzTd);
        zzb.zzc(parcel, 8, usageInfo.zzTe);
        zzb.zzI(parcel, zzav);
    }
