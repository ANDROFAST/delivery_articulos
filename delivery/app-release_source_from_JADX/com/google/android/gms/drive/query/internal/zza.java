...
public class zza implements Creator<ComparisonFilter> {
    static void zza(ComparisonFilter comparisonFilter, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, comparisonFilter.zzasa, i, false);
        zzb.zza(parcel, 2, comparisonFilter.zzasb, i, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public ComparisonFilter zzch(Parcel parcel) {
    ...
    public ComparisonFilter[] zzec(int i) {
