...
public class zze implements Creator<DriveId> {
    static void zza(DriveId driveId, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, driveId.zzamR, false);
        zzb.zza(parcel, 3, driveId.zzamS);
        zzb.zza(parcel, 4, driveId.zzamA);
        zzb.zzc(parcel, 5, driveId.zzamT);
        zzb.zzI(parcel, zzav);
    }
