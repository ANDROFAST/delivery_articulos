...
public class zzay implements Creator<OnDownloadProgressResponse> {
    static void zza(OnDownloadProgressResponse onDownloadProgressResponse, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, onDownloadProgressResponse.zzaqf);
        zzb.zza(parcel, 3, onDownloadProgressResponse.zzaqg);
        zzb.zzc(parcel, 4, onDownloadProgressResponse.zzAk);
        zzb.zzc(parcel, 5, onDownloadProgressResponse.zzaqh, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public OnDownloadProgressResponse zzby(Parcel parcel) {
        long j = 0;
        int i = 0;
    ...
    public OnDownloadProgressResponse[] zzdt(int i) {
