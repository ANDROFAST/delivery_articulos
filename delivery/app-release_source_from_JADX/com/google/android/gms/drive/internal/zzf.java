...
public class zzf implements Creator<ChangeResourceParentsRequest> {
    static void zza(ChangeResourceParentsRequest changeResourceParentsRequest, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, changeResourceParentsRequest.zzaod, i, false);
        zzb.zzc(parcel, 3, changeResourceParentsRequest.zzaoe, false);
        zzb.zzc(parcel, 4, changeResourceParentsRequest.zzaof, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public ChangeResourceParentsRequest zzba(Parcel parcel) {
        List list = null;
    ...
    public ChangeResourceParentsRequest[] zzcQ(int i) {
