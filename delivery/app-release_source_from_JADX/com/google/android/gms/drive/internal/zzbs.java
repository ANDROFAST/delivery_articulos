...
public class zzbs implements Creator<SetResourceParentsRequest> {
    static void zza(SetResourceParentsRequest setResourceParentsRequest, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, setResourceParentsRequest.zzaod, i, false);
        zzb.zzc(parcel, 3, setResourceParentsRequest.zzaqx, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public SetResourceParentsRequest zzbR(Parcel parcel) {
        List list = null;
    ...
    public SetResourceParentsRequest[] zzdM(int i) {
