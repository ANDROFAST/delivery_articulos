...
public class zzbi implements Creator<OnStartStreamSession> {
    static void zza(OnStartStreamSession onStartStreamSession, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, onStartStreamSession.zzaqr, i, false);
        zzb.zza(parcel, 3, onStartStreamSession.zzaqs, false);
        zzb.zza(parcel, 4, onStartStreamSession.zzsL, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public OnStartStreamSession zzbI(Parcel parcel) {
        String str = null;
    ...
    public OnStartStreamSession[] zzdD(int i) {
