...
public class zzi implements Creator<ValuesAddedDetails> {
    static void zza(ValuesAddedDetails valuesAddedDetails, Parcel parcel, int i) {
        ...
        zzb.zzc(parcel, 3, valuesAddedDetails.zzasJ);
        zzb.zzc(parcel, 4, valuesAddedDetails.zzasK);
        zzb.zza(parcel, 5, valuesAddedDetails.zzati, false);
        zzb.zzc(parcel, 6, valuesAddedDetails.zzatj);
        zzb.zzI(parcel, zzav);
    }
    ...
    public ValuesAddedDetails zzcG(Parcel parcel) {
        int i = 0;
    ...
    public ValuesAddedDetails[] zzeC(int i) {
