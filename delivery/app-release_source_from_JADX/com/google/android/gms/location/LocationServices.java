...
public class LocationServices {
    public static final Api<NoOptions> API = new Api("LocationServices.API", zzTp, zzTo);
    ...
    private static final com.google.android.gms.common.api.Api.zza<zzl, NoOptions> zzTp = new C07661();

    static class C07661 extends com.google.android.gms.common.api.Api.zza<zzl, NoOptions> {
        C07661() {
        }
    ...
    public static abstract class zza<R extends Result> extends com.google.android.gms.internal.zzlx.zza<R, zzl> {
        public zza(GoogleApiClient googleApiClient) {
            super(LocationServices.zzTo, googleApiClient);
        }
    }
    ...
    public static zzl zzg(GoogleApiClient googleApiClient) {
        boolean z = true;
        zzx.zzb(googleApiClient != null, (Object) "GoogleApiClient parameter is required.");
        zzl com_google_android_gms_location_internal_zzl = (zzl) googleApiClient.zza(zzTo);
