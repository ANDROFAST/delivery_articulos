...
public class zza implements Creator<AutocompletePredictionEntity> {
    static void zza(AutocompletePredictionEntity autocompletePredictionEntity, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, autocompletePredictionEntity.zzaNk, false);
        zzb.zzc(parcel, 1000, autocompletePredictionEntity.mVersionCode);
        zzb.zza(parcel, 2, autocompletePredictionEntity.zzaMO, false);
        zzb.zza(parcel, 3, autocompletePredictionEntity.zzaMp, false);
        zzb.zzc(parcel, 4, autocompletePredictionEntity.zzaNl, false);
        zzb.zzc(parcel, 5, autocompletePredictionEntity.zzaNm);
        zzb.zza(parcel, 6, autocompletePredictionEntity.zzaNn, false);
        zzb.zzc(parcel, 7, autocompletePredictionEntity.zzaNo, false);
        zzb.zza(parcel, 8, autocompletePredictionEntity.zzaNp, false);
        zzb.zzc(parcel, 9, autocompletePredictionEntity.zzaNq, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public AutocompletePredictionEntity zzfb(Parcel parcel) {
        int i = 0;
        List list = null;
    ...
    public AutocompletePredictionEntity[] zzhL(int i) {
