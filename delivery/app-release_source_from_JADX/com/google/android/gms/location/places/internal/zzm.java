...
public class zzm implements Creator<PlaceLikelihoodEntity> {
    static void zza(PlaceLikelihoodEntity placeLikelihoodEntity, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, placeLikelihoodEntity.zzaNV, i, false);
        zzb.zzc(parcel, 1000, placeLikelihoodEntity.mVersionCode);
        zzb.zza(parcel, 2, placeLikelihoodEntity.zzaNW);
        zzb.zzI(parcel, zzav);
    }
    ...
    public PlaceLikelihoodEntity zzfd(Parcel parcel) {
    ...
    public PlaceLikelihoodEntity[] zzhO(int i) {
