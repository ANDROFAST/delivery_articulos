...
public class LocationRequestCreator implements Creator<LocationRequest> {
    ...
    static void zza(LocationRequest locationRequest, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, locationRequest.zzaLk);
        zzb.zza(parcel, 3, locationRequest.zzaLl);
        zzb.zza(parcel, 4, locationRequest.zzayX);
        zzb.zza(parcel, 5, locationRequest.zzaKP);
        zzb.zzc(parcel, 6, locationRequest.zzaLm);
        zzb.zza(parcel, 7, locationRequest.zzaLn);
        zzb.zza(parcel, 8, locationRequest.zzaLo);
        zzb.zzI(parcel, zzav);
    }
