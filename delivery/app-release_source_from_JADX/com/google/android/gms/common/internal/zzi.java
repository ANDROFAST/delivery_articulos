...
public class zzi implements Creator<GetServiceRequest> {
    static void zza(GetServiceRequest getServiceRequest, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 4, getServiceRequest.zzajC, false);
        zzb.zza(parcel, 5, getServiceRequest.zzajD, false);
        zzb.zza(parcel, 6, getServiceRequest.zzajE, i, false);
        zzb.zza(parcel, 7, getServiceRequest.zzajF, false);
        zzb.zza(parcel, 8, getServiceRequest.zzajG, i, false);
        zzb.zzI(parcel, zzav);
    }
    ...
    public GetServiceRequest[] zzbS(int i) {
