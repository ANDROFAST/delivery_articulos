...
public interface zzlq extends IInterface {

    public static abstract class zza extends Binder implements zzlq {

        private static class zza implements zzlq {
        ...
        public static zzlq zzaH(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlq)) ? new zza(iBinder) : (zzlq) queryLocalInterface;
        }
