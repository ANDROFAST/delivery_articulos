...
public class zzjt extends WebChromeClient {
    ...
    static /* synthetic */ class C03537 {
        static final /* synthetic */ int[] zzMQ = new int[MessageLevel.values().length];

        static {
            try {
                zzMQ[MessageLevel.ERROR.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                zzMQ[MessageLevel.WARNING.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                zzMQ[MessageLevel.LOG.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                zzMQ[MessageLevel.TIP.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                zzMQ[MessageLevel.DEBUG.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
        }
    }

    public zzjt(zzjn com_google_android_gms_internal_zzjn) {
    ...
    private final Context zza(WebView webView) {
        ...
        Context zzhx = com_google_android_gms_internal_zzjn.zzhx();
        return zzhx == null ? com_google_android_gms_internal_zzjn.getContext() : zzhx;
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C03537.zzMQ[consoleMessage.messageLevel().ordinal()]) {
            case 1:
                zzb.m6e(str);
                break;
            case 2:
    ...
    protected final void zza(View view, int i, CustomViewCallback customViewCallback) {
        ...
        zzhA.zza(view, customViewCallback);
        zzhA.setRequestedOrientation(i);
    }
