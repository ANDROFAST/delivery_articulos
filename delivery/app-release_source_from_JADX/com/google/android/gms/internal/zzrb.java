...
public interface zzrb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrb {
        ...
        public static zzrb zzdr(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case Place.TYPE_LOCALITY /*1009*/:
                    data.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
                    zzo(data.readInt(), data.readString());
                    reply.writeNoException();
                    return true;
    ...
    void zzeK(String str) throws RemoteException;

    void zziK(int i) throws RemoteException;

    void zziL(int i) throws RemoteException;

    void zziM(int i) throws RemoteException;
