...
public interface zzey extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzey {
        ...
        private static class zza implements zzey {
            ...
            public void zza(zzez com_google_android_gms_internal_zzez) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzez != null ? com_google_android_gms_internal_zzez.asBinder() : null);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 7:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                    zza(com.google.android.gms.internal.zzez.zza.zzH(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(zzez com_google_android_gms_internal_zzez) throws RemoteException;
}
