...
public final class zzbz {
    ...
    public static final zzbv<Long> zzvB = zzbv.zza(0, "gads:video:metric_frame_hash_time_leniency", 500);
    public static final zzbv<String> zzvC = zzbv.zzd(0, "gads:spam_ad_id_decorator:experiment_id");
    public static final zzbv<Boolean> zzvD = zzbv.zza(0, "gads:spam_ad_id_decorator:enabled", Boolean.valueOf(false));
    public static final zzbv<String> zzvE = zzbv.zzd(0, "gads:looper_for_gms_client:experiment_id");
    public static final zzbv<Boolean> zzvF = zzbv.zza(0, "gads:looper_for_gms_client:enabled", Boolean.valueOf(true));
    public static final zzbv<Boolean> zzvG = zzbv.zza(0, "gads:sw_ad_request_service:enabled", Boolean.valueOf(true));
    public static final zzbv<Boolean> zzvH = zzbv.zza(0, "gads:sw_dynamite:enabled", Boolean.valueOf(true));
    ...
    public static final zzbv<Boolean> zzvL = zzbv.zza(0, "gads:enabled_sdk_csi", Boolean.valueOf(false));
    public static final zzbv<String> zzvM = zzbv.zza(0, "gads:sdk_csi_server", "https://csi.gstatic.com/csi");
    public static final zzbv<Boolean> zzvN = zzbv.zza(0, "gads:sdk_csi_write_to_file", Boolean.valueOf(false));
    public static final zzbv<Boolean> zzvO = zzbv.zza(0, "gads:enable_content_fetching", Boolean.valueOf(true));
    ...
    public static final zzbv<Boolean> zzvU = zzbv.zza(0, "gad:app_index_enabled", Boolean.valueOf(true));
    public static final zzbv<Boolean> zzvV = zzbv.zza(0, "gads:app_index:without_content_info_present:enabled", Boolean.valueOf(true));
    public static final zzbv<Long> zzvW = zzbv.zza(0, "gads:app_index:timeout_ms", 1000);
    ...
    public static final zzbv<Boolean> zzvZ = zzbv.zza(0, "gads:kitkat_interstitial_workaround:enabled", Boolean.valueOf(true));
    ...
    public static final zzbv<Long> zzvw = zzbv.zza(0, "gads:video_stream_cache:limit_time_sec", 300);
    public static final zzbv<Long> zzvx = zzbv.zza(0, "gads:video_stream_cache:notify_interval_millis", 1000);
    public static final zzbv<Integer> zzvy = zzbv.zza(0, "gads:video_stream_cache:connect_timeout_millis", (int) StatusCodes.AUTH_DISABLED);
    ...
    public static final zzbv<Long> zzwB = zzbv.zza(0, "gads:ad_loader:timeout_ms", 60000);
    public static final zzbv<Long> zzwC = zzbv.zza(0, "gads:rendering:timeout_ms", 60000);
    ...
    public static final zzbv<Boolean> zzwa = zzbv.zza(0, "gads:interstitial_follow_url", Boolean.valueOf(true));
    public static final zzbv<Boolean> zzwb = zzbv.zza(0, "gads:interstitial_follow_url:register_click", Boolean.valueOf(true));
    public static final zzbv<String> zzwc = zzbv.zzc(0, "gads:interstitial_follow_url:experiment_id");
    public static final zzbv<Boolean> zzwd = zzbv.zza(0, "gads:analytics_enabled", Boolean.valueOf(true));
    public static final zzbv<Boolean> zzwe = zzbv.zza(0, "gads:ad_key_enabled", Boolean.valueOf(false));
    ...
    public static final zzbv<Boolean> zzwi = zzbv.zza(0, "gads:ad_manager_creator:enabled", Boolean.valueOf(true));
    public static final zzbv<Boolean> zzwj = zzbv.zza(1, "gads:interstitial_ad_pool:enabled", Boolean.valueOf(false));
    ...
    public static final zzbv<Boolean> zzwp = zzbv.zza(0, "gads:log:verbose_enabled", Boolean.valueOf(false));
    public static final zzbv<Boolean> zzwq = zzbv.zza(0, "gads:device_info_caching:enabled", Boolean.valueOf(true));
    public static final zzbv<Long> zzwr = zzbv.zza(0, "gads:device_info_caching_expiry_ms:expiry", 300000);
    public static final zzbv<Boolean> zzws = zzbv.zza(0, "gads:gen204_signals:enabled", Boolean.valueOf(false));
    public static final zzbv<Boolean> zzwt = zzbv.zza(0, "gads:webview:error_reporting_enabled", Boolean.valueOf(false));
    public static final zzbv<Boolean> zzwu = zzbv.zza(0, "gads:adid_reporting:enabled", Boolean.valueOf(false));
    public static final zzbv<Boolean> zzwv = zzbv.zza(0, "gads:ad_settings_page_reporting:enabled", Boolean.valueOf(false));
    public static final zzbv<Boolean> zzww = zzbv.zza(0, "gads:adid_info_gmscore_upgrade_reporting:enabled", Boolean.valueOf(false));
    public static final zzbv<Boolean> zzwx = zzbv.zza(0, "gads:request_pkg:enabled", Boolean.valueOf(true));
    public static final zzbv<Boolean> zzwy = zzbv.zza(0, "gads:gmsg:disable_back_button:enabled", Boolean.valueOf(false));
    public static final zzbv<Long> zzwz = zzbv.zza(0, "gads:network:cache_prediction_duration_s", 300);

    public static void initialize(final Context context) {
        zziz.zzb(new Callable<Void>() {
            public /* synthetic */ Object call() throws Exception {
                return zzdm();
            }

            public Void zzdm() {
                zzp.zzbG().initialize(context);
                return null;
            }
        });
    }
