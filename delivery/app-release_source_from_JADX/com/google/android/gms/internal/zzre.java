...
public interface zzre extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzre {
        ...
        private static class zza implements zzre {
            ...
            public void zza(zzrd com_google_android_gms_internal_zzrd, Uri uri, Bundle bundle, boolean z) throws RemoteException {
                ...
                try {
                    ...
                    if (com_google_android_gms_internal_zzrd != null) {
                        iBinder = com_google_android_gms_internal_zzrd.asBinder();
                    }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzrd.zza.zzdF(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    void zza(zzrd com_google_android_gms_internal_zzrd, Uri uri, Bundle bundle, boolean z) throws RemoteException;
}
