...
public interface zzda extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzda {
        ...
        private static class zza implements zzda {
        ...
        public static zzda zzC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzda)) ? new zza(iBinder) : (zzda) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(com.google.android.gms.internal.zzcv.zza.zzy(data.readStrongBinder()));
