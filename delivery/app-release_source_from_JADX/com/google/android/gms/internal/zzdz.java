...
public class zzdz extends zzdw {
    ...
    public zzdz(zzjn com_google_android_gms_internal_zzjn) {
        super(com_google_android_gms_internal_zzjn);
        File cacheDir = com_google_android_gms_internal_zzjn.getContext().getCacheDir();
        if (cacheDir == null) {
        ...
        if (!this.zzzx.isDirectory() && !this.zzzx.mkdirs()) {
            ...
            this.zzzx = null;
        } else if (!this.zzzx.setReadable(true, false) || !this.zzzx.setExecutable(true, false)) {
    ...
    L_0x0013:
        r3 = r26.zzdT();
        r2 = com.google.android.gms.internal.zzbz.zzvt;
        r2 = r2.get();
    ...
    L_0x00d9:
        ...
        r2 = com.google.android.gms.internal.zzbz.zzvy;	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
    ...
    L_0x0153:
        r6 = com.google.android.gms.ads.internal.zzp.zzbA();
        r7 = 1;
        r6.zzb(r2, r7);
    L_0x015b:
    ...
    L_0x01c1:
        ...
        com.google.android.gms.ads.internal.util.client.zzb.zzaH(r2);	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        ...
        r2 = zzzv;	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        r2.remove(r13);	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        r2 = 0;
        goto L_0x0012;
    L_0x01ef:
        r2 = zzzw;	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        ...
        r2 = com.google.android.gms.internal.zzbz.zzvu;	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        r2 = r2.get();	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        r2 = (java.lang.Integer) r2;	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
    ...
    L_0x024e:
        ...
        r2 = r2.append(r0);	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        r2 = r2.toString();	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        com.google.android.gms.ads.internal.util.client.zzb.zzaF(r2);	 Catch:{ IOException -> 0x03de, RuntimeException -> 0x03c7 }
        ...
        r18 = com.google.android.gms.ads.internal.zzp.zzbB();	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
        r5 = 0;
        r20 = r18.currentTimeMillis();	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
        r2 = com.google.android.gms.internal.zzbz.zzvx;	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
        ...
        r19 = new com.google.android.gms.internal.zzix;	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
        r0 = r19;
        r0.<init>(r2);	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
        r2 = com.google.android.gms.internal.zzbz.zzvw;	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
        r2 = r2.get();	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
        r2 = (java.lang.Long) r2;	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
    ...
    L_0x0324:
        r0 = r26;
        r2 = r0.zzzy;	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
    ...
    L_0x035d:
        r2 = zzzw;	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
        ...
        com.google.android.gms.ads.internal.util.client.zzb.zzaF(r2);	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
    L_0x0386:
        r2 = 1;
        r3 = 0;
        ...
        r2 = zzzv;	 Catch:{ IOException -> 0x034d, RuntimeException -> 0x03d3 }
    ...
    public int zzdT() {
        int i = 0;
        if (this.zzzx != null) {
            for (File name : this.zzzx.listFiles()) {
    ...
    public boolean zzdU() {
        ...
        File[] listFiles = this.zzzx.listFiles();
