...
public interface zzso extends IInterface {

    public static abstract class zza extends Binder implements zzso {

        private static class zza implements zzso {
        ...
        public static zzso zzef(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzso)) ? new zza(iBinder) : (zzso) queryLocalInterface;
        }
