...
public interface zzsr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsr {

        private static class zza implements zzsr {
        ...
        public static zzsr zzei(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsr)) ? new zza(iBinder) : (zzsr) queryLocalInterface;
        }
