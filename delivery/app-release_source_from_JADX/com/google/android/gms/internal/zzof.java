...
public class zzof {
    ...
    public static final MetadataField<String> zzaqR = new zzo(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, 4300000);
    ...
    public static final MetadataField<Long> zzaqU = new com.google.android.gms.drive.metadata.internal.zzg("fileSize", 4300000);
    ...
    public static final MetadataField<BitmapTeleporter> zzart = new zzj<BitmapTeleporter>("thumbnail", Collections.emptySet(), Collections.emptySet(), 4400000) {
        protected /* synthetic */ Object zzc(DataHolder dataHolder, int i, int i2) {
    ...
    public static final zzg zzaru = new zzg(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_TITLE, 4100000);
