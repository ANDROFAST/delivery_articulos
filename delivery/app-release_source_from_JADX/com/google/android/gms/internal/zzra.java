...
public final class zzra implements Connections {
    public static final com.google.android.gms.common.api.Api.zzc<zzqz> zzTo = new com.google.android.gms.common.api.Api.zzc();
    public static final com.google.android.gms.common.api.Api.zza<zzqz, NoOptions> zzTp = new C07621();

    static class C07621 extends com.google.android.gms.common.api.Api.zza<zzqz, NoOptions> {
        C07621() {
        }
    ...
    private static abstract class zzb extends zza<StartAdvertisingResult> {
        ...
        public StartAdvertisingResult zzaY(final Status status) {
    ...
    public PendingResult<Status> acceptConnectionRequest(GoogleApiClient apiClient, String remoteEndpointId, byte[] payload, MessageListener messageListener) {
        final zzmn zzq = apiClient.zzq(messageListener);
        ...
        return apiClient.zzb(new zzc(this, apiClient) {
            ...
            protected void zza(zzqz com_google_android_gms_internal_zzqz) throws RemoteException {
                com_google_android_gms_internal_zzqz.zza((com.google.android.gms.internal.zzlx.zzb) this, str, bArr, zzq);
            }
        });
    }
    ...
    public PendingResult<Status> rejectConnectionRequest(GoogleApiClient apiClient, final String remoteEndpointId) {
        return apiClient.zzb(new zzc(this, apiClient) {
            ...
            protected void zza(zzqz com_google_android_gms_internal_zzqz) throws RemoteException {
                com_google_android_gms_internal_zzqz.zzp(this, remoteEndpointId);
            }
        });
    }
    ...
    public PendingResult<Status> sendConnectionRequest(GoogleApiClient apiClient, String name, String remoteEndpointId, byte[] payload, ConnectionResponseCallback connectionResponseCallback, MessageListener messageListener) {
        final zzmn zzq = apiClient.zzq(connectionResponseCallback);
        final zzmn zzq2 = apiClient.zzq(messageListener);
        ...
        return apiClient.zzb(new zzc(this, apiClient) {
            ...
            protected void zza(zzqz com_google_android_gms_internal_zzqz) throws RemoteException {
                com_google_android_gms_internal_zzqz.zza(this, str, str2, bArr, zzq, zzq2);
            }
        });
    }
    ...
    public PendingResult<StartAdvertisingResult> startAdvertising(GoogleApiClient apiClient, String name, AppMetadata appMetadata, long durationMillis, ConnectionRequestListener connectionRequestListener) {
        final zzmn zzq = apiClient.zzq(connectionRequestListener);
        final String str = name;
        ...
        return apiClient.zzb(new zzb(this, apiClient) {
            ...
            protected void zza(zzqz com_google_android_gms_internal_zzqz) throws RemoteException {
                com_google_android_gms_internal_zzqz.zza(this, str, appMetadata2, j, zzq);
            }
        });
    }
    ...
    public PendingResult<Status> startDiscovery(GoogleApiClient apiClient, String serviceId, long durationMillis, EndpointDiscoveryListener listener) {
        final zzmn zzq = apiClient.zzq(listener);
        ...
        return apiClient.zzb(new zzc(this, apiClient) {
            ...
            protected void zza(zzqz com_google_android_gms_internal_zzqz) throws RemoteException {
                com_google_android_gms_internal_zzqz.zza((com.google.android.gms.internal.zzlx.zzb) this, str, j, zzq);
            }
        });
    }
