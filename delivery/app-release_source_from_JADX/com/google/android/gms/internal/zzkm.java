...
public interface zzkm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkm {

        private static class zza implements zzkm {
        ...
        public static zzkm zzak(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.appinvite.internal.IAppInviteCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkm)) ? new zza(iBinder) : (zzkm) queryLocalInterface;
        }
