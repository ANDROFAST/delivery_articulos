...
@zzha
public class zzgz implements UncaughtExceptionHandler {
    private Context mContext;
    private VersionInfoParcel zzDY;
    private UncaughtExceptionHandler zzGb;
    private UncaughtExceptionHandler zzGc;

    public zzgz(Context context, VersionInfoParcel versionInfoParcel, UncaughtExceptionHandler uncaughtExceptionHandler, UncaughtExceptionHandler uncaughtExceptionHandler2) {
    ...
    public static zzgz zza(Context context, Thread thread, VersionInfoParcel versionInfoParcel) {
        ...
        UncaughtExceptionHandler com_google_android_gms_internal_zzgz = new zzgz(context, versionInfoParcel, uncaughtExceptionHandler, Thread.getDefaultUncaughtExceptionHandler());
        if (uncaughtExceptionHandler != null && (uncaughtExceptionHandler instanceof zzgz)) {
            return (zzgz) uncaughtExceptionHandler;
        }
        try {
            thread.setUncaughtExceptionHandler(com_google_android_gms_internal_zzgz);
            return com_google_android_gms_internal_zzgz;
        } catch (Throwable e) {
    ...
    public void zza(Throwable th, boolean z) {
        if (zzA(this.mContext)) {
            ...
            if (zzb != null) {
                ...
                zzp.zzbx().zza(this.mContext, this.zzDY.afmaVersion, arrayList, zzp.zzbA().zzgP());
            }
        }
    }
