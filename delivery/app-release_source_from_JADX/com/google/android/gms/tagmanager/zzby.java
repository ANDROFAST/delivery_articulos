...
class zzby implements zzau {
    ...
    class zzb extends SQLiteOpenHelper {
        final /* synthetic */ zzby zzbeD;
        private boolean zzbeE;
        private long zzbeF = 0;

        zzb(zzby com_google_android_gms_tagmanager_zzby, Context context, String str) {
            this.zzbeD = com_google_android_gms_tagmanager_zzby;
        ...
        public SQLiteDatabase getWritableDatabase() {
            if (!this.zzbeE || this.zzbeF + 3600000 <= this.zzbeD.zzqD.currentTimeMillis()) {
                SQLiteDatabase sQLiteDatabase = null;
                this.zzbeE = true;
                this.zzbeF = this.zzbeD.zzqD.currentTimeMillis();
                try {
                    sQLiteDatabase = super.getWritableDatabase();
                } catch (SQLiteException e) {
                    this.zzbeD.mContext.getDatabasePath(this.zzbeD.zzbeA).delete();
                }
    ...
    class zza implements com.google.android.gms.tagmanager.zzcx.zza {
        ...
        public void zza(zzaq com_google_android_gms_tagmanager_zzaq) {
            this.zzbeD.zzq(com_google_android_gms_tagmanager_zzaq.zzEH());
        }

        public void zzb(zzaq com_google_android_gms_tagmanager_zzaq) {
            this.zzbeD.zzq(com_google_android_gms_tagmanager_zzaq.zzEH());
            zzbg.m10v("Permanent failure dispatching hitId: " + com_google_android_gms_tagmanager_zzaq.zzEH());
        }

        public void zzc(zzaq com_google_android_gms_tagmanager_zzaq) {
            long zzEI = com_google_android_gms_tagmanager_zzaq.zzEI();
            if (zzEI == 0) {
                this.zzbeD.zzd(com_google_android_gms_tagmanager_zzaq.zzEH(), this.zzbeD.zzqD.currentTimeMillis());
            } else if (zzEI + 14400000 < this.zzbeD.zzqD.currentTimeMillis()) {
                this.zzbeD.zzq(com_google_android_gms_tagmanager_zzaq.zzEH());
                zzbg.m10v("Giving up on failed hitId: " + com_google_android_gms_tagmanager_zzaq.zzEH());
            }
        }
    }
    ...
    zzby(zzav com_google_android_gms_tagmanager_zzav, Context context, String str, int i) {
        ...
        this.zzbeA = str;
        this.zzbez = com_google_android_gms_tagmanager_zzav;
        this.zzqD = zzno.zzrM();
        this.zzbex = new zzb(this, this.mContext, this.zzbeA);
        this.zzbey = new zzcx(new DefaultHttpClient(), this.mContext, new zza(this));
        this.zzbeB = 0;
        this.zzbeC = i;
    }

    private void zzEU() {
        int zzEV = (zzEV() - this.zzbeC) + 1;
        if (zzEV > 0) {
            List zzjU = zzjU(zzEV);
            zzbg.m10v("Store full, deleting " + zzjU.size() + " hits to make room.");
            zzf((String[]) zzjU.toArray(new String[0]));
        }
    }

    private void zzd(long j, long j2) {
        SQLiteDatabase zzfn = zzfn("Error opening database for getNumStoredHits.");
        if (zzfn != null) {
            ContentValues contentValues = new ContentValues();
            contentValues.put("hit_first_send_time", Long.valueOf(j2));
            try {
                zzfn.update("gtm_hits", contentValues, "hit_id=?", new String[]{String.valueOf(j)});
            } catch (SQLiteException e) {
    ...
    private SQLiteDatabase zzfn(String str) {
        try {
            return this.zzbex.getWritableDatabase();
        } catch (SQLiteException e) {
            zzbg.zzaH(str);
            return null;
        }
    ...
    private void zzh(long j, String str) {
        SQLiteDatabase zzfn = zzfn("Error opening database for putHit");
        if (zzfn != null) {
            ContentValues contentValues = new ContentValues();
            ...
            try {
                zzfn.insert("gtm_hits", null, contentValues);
    ...
    public void dispatch() {
        zzbg.m10v("GTM Dispatch running...");
        if (this.zzbey.zzEA()) {
            List zzjV = zzjV(40);
            if (zzjV.isEmpty()) {
                zzbg.m10v("...nothing to dispatch");
    ...
    int zzEV() {
        ...
        if (zzfn != null) {
            try {
                cursor = zzfn.rawQuery("SELECT COUNT(*) from gtm_hits", null);
    ...
    int zzEW() {
        ...
        int count;
        try {
            Cursor query = zzfn.query("gtm_hits", new String[]{"hit_id", "hit_first_send_time"}, "hit_first_send_time=0", null, null, null, null);
            try {
    ...
    void zzf(String[] strArr) {
        ...
        if (strArr != null && strArr.length != 0) {
            SQLiteDatabase zzfn = zzfn("Error opening database for deleteHits.");
            if (zzfn != null) {
                try {
                    zzfn.delete("gtm_hits", String.format("HIT_ID in (%s)", new Object[]{TextUtils.join(",", Collections.nCopies(strArr.length, "?"))}), strArr);
                    zzav com_google_android_gms_tagmanager_zzav = this.zzbez;
                    if (zzEV() != 0) {
                        z = false;
                    }
                    com_google_android_gms_tagmanager_zzav.zzav(z);
                } catch (SQLiteException e) {
    ...
    List<String> zzjU(int i) {
        ...
        SQLiteDatabase zzfn = zzfn("Error opening database for peekHitIds.");
        if (zzfn == null) {
            return arrayList;
        }
        Cursor query;
        try {
            query = zzfn.query("gtm_hits", new String[]{"hit_id"}, null, null, null, null, String.format("%s ASC", new Object[]{"hit_id"}), Integer.toString(i));
            try {
                ...
                e = e2;
                try {
                    zzbg.zzaH("Error in peekHits fetching hitIds: " + e.getMessage());
                    if (query != null) {
                        query.close();
                    }
                    return arrayList;
    ...
    public java.util.List<com.google.android.gms.tagmanager.zzaq> zzjV(int r17) {
        /*
        r16 = this;
    ...
    L_0x00ac:
        ...
        r2.zzfr(r5);	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
    L_0x00ba:
        r2 = r4 + 1;
    ...
    L_0x00ce:
        ...
        com.google.android.gms.tagmanager.zzbg.zzaH(r3);	 Catch:{ all -> 0x016e }
    ...
    L_0x00f6:
        ...
        r2 = r12.get(r4);	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        r2 = (com.google.android.gms.tagmanager.zzaq) r2;	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        r8 = r2.zzEH();	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        ...
        com.google.android.gms.tagmanager.zzbg.zzaH(r2);	 Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        goto L_0x00ba;
    L_0x0114:
        r2 = move-exception;
        r13 = r3;
    L_0x0116:
        ...
        com.google.android.gms.tagmanager.zzbg.zzaH(r2);	 Catch:{ all -> 0x015f }
    ...
    L_0x017d:
        ...
        goto L_0x009e;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.zzby.zzjV(int):java.util.List<com.google.android.gms.tagmanager.zzaq>");
    }

    int zzjw() {
        boolean z = true;
        long currentTimeMillis = this.zzqD.currentTimeMillis();
        if (currentTimeMillis <= this.zzbeB + 86400000) {
            return 0;
        }
        this.zzbeB = currentTimeMillis;
        SQLiteDatabase zzfn = zzfn("Error opening database for deleteStaleHits.");
        if (zzfn == null) {
            return 0;
        }
        int delete = zzfn.delete("gtm_hits", "HIT_TIME < ?", new String[]{Long.toString(this.zzqD.currentTimeMillis() - 2592000000L)});
        zzav com_google_android_gms_tagmanager_zzav = this.zzbez;
        if (zzEV() != 0) {
            z = false;
        }
