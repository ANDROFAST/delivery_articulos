...
public class zzq implements Creator<ReadRawRequest> {
    static void zza(ReadRawRequest readRawRequest, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 1, readRawRequest.zzui(), false);
        zzb.zzc(parcel, 1000, readRawRequest.getVersionCode());
        zzb.zzc(parcel, 3, readRawRequest.zzut(), false);
        zzb.zza(parcel, 4, readRawRequest.zzuo());
        zzb.zza(parcel, 5, readRawRequest.zzun());
        zzb.zzI(parcel, zzav);
    }
    ...
    public ReadRawRequest zzdq(Parcel parcel) {
        List list = null;
        boolean z = false;
    ...
    public ReadRawRequest[] zzfq(int i) {
