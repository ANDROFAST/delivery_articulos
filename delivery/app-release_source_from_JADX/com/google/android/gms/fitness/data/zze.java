...
public class zze implements Creator<DataSet> {
    static void zza(DataSet dataSet, Parcel parcel, int i) {
        ...
        zzb.zzd(parcel, 3, dataSet.zztI(), false);
        zzb.zzc(parcel, 4, dataSet.zztJ(), false);
        zzb.zza(parcel, 5, dataSet.zztA());
        zzb.zzI(parcel, zzav);
    }
    ...
    public DataSet zzcN(Parcel parcel) {
        boolean z = false;
        List list = null;
