...
public class zzd implements Creator<DataPoint> {
    static void zza(DataPoint dataPoint, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 4, dataPoint.zztH());
        zzb.zza(parcel, 5, dataPoint.zztD(), i, false);
        zzb.zza(parcel, 6, dataPoint.getOriginalDataSource(), i, false);
        zzb.zza(parcel, 7, dataPoint.zztE());
        zzb.zza(parcel, 8, dataPoint.zztF());
        zzb.zzI(parcel, zzav);
    }
    ...
    public DataPoint zzcM(Parcel parcel) {
