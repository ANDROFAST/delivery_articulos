...
public class PutDataRequest implements SafeParcelable {
    ...
    private static final long zzblW = TimeUnit.MINUTES.toMillis(30);
    ...
    public static PutDataRequest createWithAutoAppendedId(String pathPrefix) {
        ...
        return new PutDataRequest(2, zzfX(stringBuilder.toString()));
    }

    private static Uri zzfX(String str) {
    ...
    public Map<String, Asset> getAssets() {
        ...
        for (String str : this.zzblY.keySet()) {
            hashMap.put(str, (Asset) this.zzblY.getParcelable(str));
        }
    ...
    public PutDataRequest putAsset(String key, Asset value) {
        zzx.zzy(key);
        zzx.zzy(value);
        this.zzblY.putParcelable(key, value);
        return this;
    }
    ...
    public String toString(boolean verbose) {
        ...
        if (verbose) {
            stringBuilder.append("]\n  assets: ");
            for (String str : this.zzblY.keySet()) {
                stringBuilder.append("\n    " + str + ": " + this.zzblY.getParcelable(str));
            }
            stringBuilder.append("\n  ]");
