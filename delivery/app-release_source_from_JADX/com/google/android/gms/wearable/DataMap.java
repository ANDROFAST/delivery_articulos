...
public class DataMap {
    ...
    public static DataMap fromByteArray(byte[] bytes) {
        try {
            return zzsy.zza(new zza(zzsz.zzz(bytes), new ArrayList()));
        } catch (Throwable e) {
    ...
    public boolean containsKey(String key) {
        return this.zzblT.containsKey(key);
    }
    ...
    public <T> T get(String key) {
        return this.zzblT.get(key);
    }

    public Asset getAsset(String key) {
        Object obj = this.zzblT.get(key);
        if (obj == null) {
            return null;
        }
        try {
    ...
    public void putAll(DataMap dataMap) {
        for (String str : dataMap.keySet()) {
            this.zzblT.put(str, dataMap.get(str));
        }
    }

    public void putAsset(String key, Asset value) {
        this.zzblT.put(key, value);
    }

    public void putBoolean(String key, boolean value) {
        this.zzblT.put(key, Boolean.valueOf(value));
    }

    public void putByte(String key, byte value) {
        this.zzblT.put(key, Byte.valueOf(value));
    }
    ...
    public void putDouble(String key, double value) {
        this.zzblT.put(key, Double.valueOf(value));
    }

    public void putFloat(String key, float value) {
        this.zzblT.put(key, Float.valueOf(value));
    }
    ...
    public void putInt(String key, int value) {
        this.zzblT.put(key, Integer.valueOf(value));
    }
    ...
    public void putLong(String key, long value) {
        this.zzblT.put(key, Long.valueOf(value));
    }
    ...
    public Bundle toBundle() {
        ...
        for (String str : this.zzblT.keySet()) {
            zzb(bundle, str, this.zzblT.get(str));
        }
        return bundle;
    }
