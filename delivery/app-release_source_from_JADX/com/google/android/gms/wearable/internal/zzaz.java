...
public interface zzaz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaz {
        ...
        private static class zza implements zzaz {
            ...
            public void zza(EnqueueLargeAssetResponse enqueueLargeAssetResponse) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.wearable.internal.IWearableCallbacks");
            ...
            public void zza(GetLargeAssetQueueStateResponse getLargeAssetQueueStateResponse) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.wearable.internal.IWearableCallbacks");
            ...
            public void zza(RemoveLargeAssetQueueEntriesResponse removeLargeAssetQueueEntriesResponse) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.wearable.internal.IWearableCallbacks");
        ...
        public static zzaz zzep(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 31:
                    ...
                    data.enforceInterface("com.google.android.gms.wearable.internal.IWearableCallbacks");
                    if (data.readInt() != 0) {
                        enqueueLargeAssetResponse = (EnqueueLargeAssetResponse) EnqueueLargeAssetResponse.CREATOR.createFromParcel(data);
                    }
                    zza(enqueueLargeAssetResponse);
                    reply.writeNoException();
                    return true;
                case 32:
                    ...
                    data.enforceInterface("com.google.android.gms.wearable.internal.IWearableCallbacks");
                    if (data.readInt() != 0) {
                        removeLargeAssetQueueEntriesResponse = (RemoveLargeAssetQueueEntriesResponse) RemoveLargeAssetQueueEntriesResponse.CREATOR.createFromParcel(data);
                    }
                    zza(removeLargeAssetQueueEntriesResponse);
                    reply.writeNoException();
                    return true;
                case 33:
                    ...
                    data.enforceInterface("com.google.android.gms.wearable.internal.IWearableCallbacks");
                    if (data.readInt() != 0) {
                        getLargeAssetQueueStateResponse = (GetLargeAssetQueueStateResponse) GetLargeAssetQueueStateResponse.CREATOR.createFromParcel(data);
                    }
                    zza(getLargeAssetQueueStateResponse);
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(EnqueueLargeAssetResponse enqueueLargeAssetResponse) throws RemoteException;
    ...
    void zza(GetLargeAssetQueueStateResponse getLargeAssetQueueStateResponse) throws RemoteException;
    ...
    void zza(RemoveLargeAssetQueueEntriesResponse removeLargeAssetQueueEntriesResponse) throws RemoteException;
