...
public class zzn implements Creator<ChannelEventParcelable> {
    static void zza(ChannelEventParcelable channelEventParcelable, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, channelEventParcelable.zzbmX, i, false);
        zzb.zzc(parcel, 3, channelEventParcelable.type);
        zzb.zzc(parcel, 4, channelEventParcelable.zzbmV);
        zzb.zzc(parcel, 5, channelEventParcelable.zzbmW);
        zzb.zzI(parcel, zzav);
    }
    ...
    public ChannelEventParcelable zzhR(Parcel parcel) {
        int i = 0;
    ...
    public ChannelEventParcelable[] zzlr(int i) {
